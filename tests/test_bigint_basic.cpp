...
class BigIntBaseConversionTest : public ::testing::TestWithParam<BaseConversionTestCase> {};
...
INSTANTIATE_TEST_SUITE_P(
    BaseConversions, BigIntBaseConversionTest,
    ::testing::Values(
        // Binary (base 2)
        BaseConversionTestCase{"0", 2, "0"}, BaseConversionTestCase{"1", 2, "1"},
        BaseConversionTestCase{"10", 2, "2"}, BaseConversionTestCase{"11111111", 2, "255"},
        BaseConversionTestCase{"100000000", 2, "256"},
        // Note: Octal (base 8) is not supported by this library
        // Decimal (base 10)
        BaseConversionTestCase{"0", 10, "0"}, BaseConversionTestCase{"255", 10, "255"},
        BaseConversionTestCase{"12345678901234567890", 10, "12345678901234567890"},
        // Hexadecimal (base 16)
        BaseConversionTestCase{"0", 16, "0"}, BaseConversionTestCase{"F", 16, "15"},
        BaseConversionTestCase{"FF", 16, "255"}, BaseConversionTestCase{"100", 16, "256"},
